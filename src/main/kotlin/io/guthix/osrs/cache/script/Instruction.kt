...
open class InstructionDefinition(val opcode: Int, val name: String) {
    ...
    internal companion object {
        ...
        val STOCKMARKET_GETOFFERCOMPLETEDCOUNT = InstructionDefinition(3907, "stockmarket_getoffercompletedcount")
        val STOCKMARKET_GETOFFERCOMPLETEDGOLD = InstructionDefinition(3908, "stockmarket_getoffercompletedgold")
        ...
        val TRADINGPOST_SORTFILTERBY_WORLD = InstructionDefinition(3916, "tradingpost_sortfilterby_world")
        ...
        val TRADINGPOST_GETOFFERPREVIOUSNAME = InstructionDefinition(3922, "tradingpost_getofferpreviousname")
        ...
        val WORLDMAP_JUMPTODISPLAYCOORD_INSTANT = InstructionDefinition(6607, "worldmap_jumptodisplaycoord_instant")
        val WORLDMAP_JUMPTOSOURCECOORD = InstructionDefinition(6608, "worldmap_jumptosourcecoord")
        val WORLDMAP_JUMPTOSOURCECOORD_INSTANT = InstructionDefinition(6609, "worldmap_jumptosourcecoord_instant")
        ...
        val WORLDMAP_DISABLEELEMENTCATEGORY = InstructionDefinition(6634, "worldmap_disableelementcategory")
        ...
        val WORLDMAP_GETDISABLEELEMENTCATEGORY = InstructionDefinition(6637, "worldmap_getdisableelementcategory")
