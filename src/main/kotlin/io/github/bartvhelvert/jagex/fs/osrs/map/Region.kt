 ...
 */
package io.github.bartvhelvert.jagex.fs.osrs.map

import io.github.bartvhelvert.jagex.fs.io.smallUSmart
...
class Region @ExperimentalUnsignedTypes constructor(
    ...
    companion object {
        ...
        fun decode(landBuffer: ByteBuffer, mapBuffer: ByteBuffer, baseX: Int, baseY: Int): Region {
            ...
            return Region(land.tileHeights, land.renderRules, land.overlayIds, land.overlayPaths, land.overlayRotations,
...
class Land(
    ...
    companion object {
        ...
        fun decode(buffer: ByteBuffer, baseX: Int, baseY: Int): Land {
            val tileHeights = Array(Region.FLOOR_COUNT) { Array(Region.SIZE) { IntArray(Region.SIZE) } }
            val renderRules = Array(Region.FLOOR_COUNT) { Array(Region.SIZE) { UByteArray(Region.SIZE) } }
            val overlayIds = Array(Region.FLOOR_COUNT) { Array(Region.SIZE) { ByteArray(Region.SIZE) } }
            val overlayPaths = Array(Region.FLOOR_COUNT) { Array(Region.SIZE) { UByteArray(Region.SIZE) } }
            val overlayRotations = Array(Region.FLOOR_COUNT) { Array(Region.SIZE) { UByteArray(Region.SIZE) } }
            val underlayIds = Array(Region.FLOOR_COUNT) { Array(Region.SIZE) { UByteArray(Region.SIZE) } }
